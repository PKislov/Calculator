...
//=============================================================
    ...
    void pow_ (complex &temp1, complex &temp2, complex *result)
    {
        ...
        if (temp1.Re == 0. && temp1.Im == 0. && (temp2.Re != 0. || temp2.Im != 0.)) // ноль в степени...
        {
            result->Re = result->Im = 0.;
            return;
        }
        else
            if (temp1.Re == 0. && temp1.Im == 0. && temp2.Re == 0. && temp2.Im == 0.) // ноль в степени ноль
            {
                result->Re = 1.;
                result->Im = 0.;
                return;
...
//=============================================================
    // округление комплексной и действительной части числа до ближайшего целого
